...
<body>
    ...
    <div class="container">
        <div class="formDiv">
            ...
            <p>
                si vous etes un nouveau lecteur ,veuillez vous enregistrez en remplissant le formulaire ci-dessous:
            </p>
            <form name="frmRegistration" method="post" action="lecteurForm.php">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" aria-describedby="lecadresse" id="lecadresse" name="lecadresse" placeholder="bloc b n 22 " value="<?php if (isset($_POST['lecadresse'])) echo $_POST['lecadresse']; ?>" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input class="btn btn-info active" type="submit" name="lecture" value="valider" class="btnRegister">
                </div>
            </form>
        </div>
    </div>
